...
import { ArrowUpRight, ArrowRight, ArrowLeft, Loader2, Check, ExternalLink } from "lucide-react";
import {
  PublicKey,
  Transaction,
  SystemProgram,
...
/* ============================================================
   Vault Detail — tabs + actions, rendered inline at /
   ============================================================ */
function VaultDetail({ vault }: { vault: FoundationVault }) {
  const risk = RISK_CONFIG[vault.riskTier];
  const logo = PROTOCOL_LOGO[vault.protocol];
