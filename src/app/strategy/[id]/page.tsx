...
import { getTxUrl, USDC_MINT } from "@/lib/constants";
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-12">
      ...
      <div className="mb-8">
        ...
        <h1 className="mb-2 font-serif text-3xl font-light text-foreground">{vault.name}</h1>
          ...
          <div className="border border-white/[0.06] p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-mono text-sm text-foreground">fdnALPHA (Token-2022)</span>
              </div>
              <div className="flex justify-between">
...
function DepositForm({ vault }: { vault: FoundationVault }) {
  ...
  const handleDeposit = async (e: React.FormEvent) => {
    ...
    if (!vault.multisig) {
      setError("Vault not configured yet — coming soon");
      return;
    }
    ...
    try {
      ...
      const vaultPubkey = new PublicKey(vault.multisig);

      // Build USDC transfer: user → vault multisig
      const userUsdcAta = getAssociatedTokenAddressSync(USDC_PUBKEY, wallet.publicKey);
      const vaultUsdcAta = getAssociatedTokenAddressSync(USDC_PUBKEY, vaultPubkey);
      ...
      // Notify backend to mint fdnALPHA
    ...
    return (
      <div className="border border-white/[0.06] p-6">
        ...
        <p className="mb-3 text-xs text-muted-foreground">
          Your USDC has been deposited. fdnALPHA receipt tokens will be minted to your wallet.
        </p>
        <a
        ...
        {amount && parseFloat(amount) > 0 && (
          <div className="mb-4 space-y-1.5">
            <div className="flex justify-between font-mono text-xs">
              ...
              <span className="text-foreground">fdnALPHA</span>
            </div>
            <div className="flex justify-between font-mono text-xs">
